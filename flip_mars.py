...
class GaGan(object):
    ...
    def __init__(self):
        ...
        self.airsim = airsim
        self.dir = 'D:/search_sets/mars/multi/flip2/'
    ...
    def retrieveImages(self, x, numSet):
        self.dir = "D:/search_sets/mars/multi/flip2/set" + str(numSet)
    ...
    def searchAlgo(self, n_gen, pop_size, numSet):
        path = "D:/search_sets/mars/multi/flip2/set" + str(numSet)
...
class GanProblem(pymoo.problems.multi.Problem):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        path = "D:/search_sets/mars/multi/flip2/set" + str(self.numSet) + "/"
        print('@@@@@', path)
        F = []
        import psutil
