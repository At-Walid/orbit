...
class GaGan(object):
    ...
    def __init__(self):
        ...
        self.airsim = airsim
        self.dir = 'D:/search_sets/mars/uncertainty_cyclegan/'
    ...
    def retrieveImages(self, x, numSet):
        self.dir = "D:/search_sets/mars/uncertainty_cyclegan/set" + str(numSet)
    ...
    def searchAlgo(self, n_gen, pop_size, numSet):
        path = "D:/search_sets/mars/uncertainty_cyclegan/set" + str(numSet)
...
class GanProblem(pymoo.problems.multi.Problem):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        path = "D:/search_sets/mars/uncertainty_cyclegan/set" + str(self.numSet) + "/"
        os.makedirs(path, exist_ok = True) 
        F = []
        import psutil
