...
class GaGan(object):
    ...
    def __init__(self):
        ...
        self.airsim = airsim
        self.dir = 'D:/search_sets/mars/multi/surprise/'
    ...
    def retrieveImages(self, x, numSet):
        self.dir = "D:/search_sets/mars/multi/surprise/set" + str(numSet)
    ...
    def searchAlgo(self, n_gen, pop_size, numSet, kde):
        path = "D:/search_sets/mars/multi/surprise/set" + str(numSet)
        ...
        MyProblem = GanProblem(n_gen, pop_size, rows, self, DNN, GAN, numSet, kde)
        print(MyProblem)
...
class GanProblem(pymoo.problems.multi.Problem):
    def __init__(self, n_gen, pop_size, rows, myGaGan, DNN, GAN, numSet, kde, **kwargs):
        self.problemDict = []
        self.n_gen = n_gen
    ...
    def _evaluate(self, X, out, *args, **kwargs):
            path = "D:/search_sets/mars/multi/surprise/set" + str(self.numSet) + "/"
            os.makedirs(path, exist_ok=True)
            F = []
            ...
            for x in X:
                ...
                if True:
                    ...
                    dsa_score = compute_dsa(self.kde, flattened_test_pattern)
                  
                    print('fitness = ', dsa_score)
